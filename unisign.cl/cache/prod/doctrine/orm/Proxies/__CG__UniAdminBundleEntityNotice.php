 ...
 */
class Notice extends \Uni\AdminBundle\Entity\Notice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Notice' . "\0" . 'id', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Notice' . "\0" . 'title', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Notice' . "\0" . 'content', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Notice' . "\0" . 'published', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Notice' . "\0" . 'highlight', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Notice' . "\0" . 'createdAt', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Notice' . "\0" . 'updatedAt', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Notice' . "\0" . 'deletedAt', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Notice' . "\0" . 'photos', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Notice' . "\0" . 'category');
        }
