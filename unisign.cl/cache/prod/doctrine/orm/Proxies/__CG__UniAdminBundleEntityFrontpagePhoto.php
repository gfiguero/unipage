 ...
 */
class FrontpagePhoto extends \Uni\AdminBundle\Entity\FrontpagePhoto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Uni\\AdminBundle\\Entity\\FrontpagePhoto' . "\0" . 'id', '' . "\0" . 'Uni\\AdminBundle\\Entity\\FrontpagePhoto' . "\0" . 'path', '' . "\0" . 'Uni\\AdminBundle\\Entity\\FrontpagePhoto' . "\0" . 'file', '' . "\0" . 'Uni\\AdminBundle\\Entity\\FrontpagePhoto' . "\0" . 'frontpage');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FrontpagePhoto $proxy) {
