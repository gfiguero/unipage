 ...
 */
class ProductPhoto extends \Uni\AdminBundle\Entity\ProductPhoto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Uni\\AdminBundle\\Entity\\ProductPhoto' . "\0" . 'id', '' . "\0" . 'Uni\\AdminBundle\\Entity\\ProductPhoto' . "\0" . 'path', '' . "\0" . 'Uni\\AdminBundle\\Entity\\ProductPhoto' . "\0" . 'file', '' . "\0" . 'Uni\\AdminBundle\\Entity\\ProductPhoto' . "\0" . 'product');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductPhoto $proxy) {
