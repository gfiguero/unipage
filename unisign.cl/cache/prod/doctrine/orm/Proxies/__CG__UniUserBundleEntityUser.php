...
namespace Proxies\__CG__\Uni\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Uni\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Uni\\UserBundle\\Entity\\User' . "\0" . 'firstname', '' . "\0" . 'Uni\\UserBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'Uni\\UserBundle\\Entity\\User' . "\0" . 'createdAt', '' . "\0" . 'Uni\\UserBundle\\Entity\\User' . "\0" . 'updatedAt', '' . "\0" . 'Uni\\UserBundle\\Entity\\User' . "\0" . 'deletedAt', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
