...
/**
 * lagocalafquenclDevDebugProjectContainer.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class lagocalafquenclDevDebugProjectContainer extends Container
{
    private $parameters;
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'zadmin_unipage', 'user' => 'demo', 'password' => 'ta5yputy6', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $c, $g, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_581f39778df8676087f826f1e6ba0ecfbc0a5435917b07449b3bc965aa6cab72');
    ...
    /**
     * Gets the 'google.adwords' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AntiMattr\GoogleBundle\Adwords A AntiMattr\GoogleBundle\Adwords instance.
     */
    ...
    /**
     * Gets the 'google.maps' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AntiMattr\GoogleBundle\MapsManager A AntiMattr\GoogleBundle\MapsManager instance.
     */
    ...
    {
        return $this->services['liip_imagine.binary.loader.default'] = new \Liip\ImagineBundle\Binary\Loader\FileSystemLoader($this->get('liip_imagine.mime_type_guesser'), $this->get('liip_imagine.extension_guesser'), ($this->targetDirs[2].'/../../public_html/lago-calafquen.cl'));
    }
    ...
    {
        return $this->services['liip_imagine.cache.resolver.default'] = new \Liip\ImagineBundle\Imagine\Cache\Resolver\WebPathResolver($this->get('filesystem'), $this->get('router.request_context'), ($this->targetDirs[2].'/../../public_html/lago-calafquen.cl'), 'media/cache');
    }
    ...
    /**
     * Gets the 'templating.helper.google_adwords' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AntiMattr\GoogleBundle\Helper\AdwordsHelper A AntiMattr\GoogleBundle\Helper\AdwordsHelper instance.
     */
    ...
    /**
     * Gets the 'templating.helper.google_maps' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AntiMattr\GoogleBundle\Helper\MapsHelper A AntiMattr\GoogleBundle\Helper\MapsHelper instance.
     */
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => ':Form:form_div_layout.html.twig'), 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    /**
     * Gets the 'twig.extension.google_adwords' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AntiMattr\GoogleBundle\Extension\AdwordsExtension A AntiMattr\GoogleBundle\Extension\AdwordsExtension instance.
     */
    ...
    /**
     * Gets the 'twig.extension.google_maps' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AntiMattr\GoogleBundle\Extension\MapsExtension A AntiMattr\GoogleBundle\Extension\MapsExtension instance.
     */
    ...
    /**
     * Gets the 'uniuser.mailer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Uni\UserBundle\Mailer\Mailer A Uni\UserBundle\Mailer\Mailer instance.
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), ($this->targetDirs[2].'/Resources/'), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'lagocalafquenclDevDebugProjectContainer',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_name' => 'zadmin_unipage',
            'database_user' => 'demo',
            'database_password' => 'ta5yputy6',
            ...
            'locale' => 'es',
            'webroot' => ($this->targetDirs[2].'/../../public_html/lago-calafquen.cl'),
            ...
            'router.options.matcher.cache_class' => 'lagocalafquenclDevUrlMatcher',
            'router.options.generator.cache_class' => 'lagocalafquenclDevUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => (__DIR__.'/assetic/routing.yml'),
            'router.cache_class_prefix' => 'lagocalafquenclDev',
            ...
            'debug.container.dump' => (__DIR__.'/lagocalafquenclDevDebugProjectContainer.xml'),
            ...
            'assetic.write_to' => ($this->targetDirs[2].'/../../public_html/lago-calafquen.cl/'),
