...
class lagocalafquenclProdProjectContainer extends Container
{
    private $parameters;
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6f832c12fecab7c1264ceb36ae774c9b2cd6e26dda3a0c9049e0e61bdb7bf78e');
        return $instance;
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'lagocalafquenclProdProjectContainer',
            ...
            'router.options.matcher.cache_class' => 'lagocalafquenclProdUrlMatcher',
            'router.options.generator.cache_class' => 'lagocalafquenclProdUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => ($this->targetDirs[2].'/config/routing.yml'),
            'router.cache_class_prefix' => 'lagocalafquenclProd',
