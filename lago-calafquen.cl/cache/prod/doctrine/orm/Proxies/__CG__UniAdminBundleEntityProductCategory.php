 ...
 */
class ProductCategory extends \Uni\AdminBundle\Entity\ProductCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Uni\\AdminBundle\\Entity\\ProductCategory' . "\0" . 'id', '' . "\0" . 'Uni\\AdminBundle\\Entity\\ProductCategory' . "\0" . 'name', '' . "\0" . 'Uni\\AdminBundle\\Entity\\ProductCategory' . "\0" . 'createdAt', '' . "\0" . 'Uni\\AdminBundle\\Entity\\ProductCategory' . "\0" . 'updatedAt', '' . "\0" . 'Uni\\AdminBundle\\Entity\\ProductCategory' . "\0" . 'deletedAt', '' . "\0" . 'Uni\\AdminBundle\\Entity\\ProductCategory' . "\0" . 'product');
        }
