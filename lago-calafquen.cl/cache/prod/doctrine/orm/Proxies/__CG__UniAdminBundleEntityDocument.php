 ...
 */
class Document extends \Uni\AdminBundle\Entity\Document implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Document' . "\0" . 'id', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Document' . "\0" . 'title', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Document' . "\0" . 'content', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Document' . "\0" . 'published', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Document' . "\0" . 'path', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Document' . "\0" . 'file', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Document' . "\0" . 'createdAt', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Document' . "\0" . 'updatedAt', '' . "\0" . 'Uni\\AdminBundle\\Entity\\Document' . "\0" . 'deletedAt');
        }
