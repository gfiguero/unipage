 ...
 */
class MemberRole extends \Uni\AdminBundle\Entity\MemberRole implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Uni\\AdminBundle\\Entity\\MemberRole' . "\0" . 'id', '' . "\0" . 'Uni\\AdminBundle\\Entity\\MemberRole' . "\0" . 'name', '' . "\0" . 'Uni\\AdminBundle\\Entity\\MemberRole' . "\0" . 'rank', '' . "\0" . 'Uni\\AdminBundle\\Entity\\MemberRole' . "\0" . 'createdAt', '' . "\0" . 'Uni\\AdminBundle\\Entity\\MemberRole' . "\0" . 'updatedAt', '' . "\0" . 'Uni\\AdminBundle\\Entity\\MemberRole' . "\0" . 'deletedAt', '' . "\0" . 'Uni\\AdminBundle\\Entity\\MemberRole' . "\0" . 'member');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MemberRole $proxy) {
