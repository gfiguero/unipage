 ...
 */
class NoticePhoto extends \Uni\AdminBundle\Entity\NoticePhoto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Uni\\AdminBundle\\Entity\\NoticePhoto' . "\0" . 'id', '' . "\0" . 'Uni\\AdminBundle\\Entity\\NoticePhoto' . "\0" . 'path', '' . "\0" . 'Uni\\AdminBundle\\Entity\\NoticePhoto' . "\0" . 'file', '' . "\0" . 'Uni\\AdminBundle\\Entity\\NoticePhoto' . "\0" . 'notice');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NoticePhoto $proxy) {
