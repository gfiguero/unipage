...
/**
 * altoplaceresclDevDebugProjectContainer.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class altoplaceresclDevDebugProjectContainer extends Container
{
    private $parameters;
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6532814f431c5a612f327d036286380f70faa59db25f7bfc8575ab567abd5011');
    ...
    {
        return $this->services['liip_imagine.binary.loader.default'] = new \Liip\ImagineBundle\Binary\Loader\FileSystemLoader($this->get('liip_imagine.mime_type_guesser'), $this->get('liip_imagine.extension_guesser'), ($this->targetDirs[2].'/../../public_html/altoplaceres.cl'));
    }
    ...
    {
        return $this->services['liip_imagine.cache.resolver.default'] = new \Liip\ImagineBundle\Imagine\Cache\Resolver\WebPathResolver($this->get('filesystem'), $this->get('router.request_context'), ($this->targetDirs[2].'/../../public_html/altoplaceres.cl'), 'media/cache');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'altoplaceresclDevDebugProjectContainer',
            ...
            'locale' => 'es',
            'webroot' => ($this->targetDirs[2].'/../../public_html/altoplaceres.cl'),
            ...
            'router.options.matcher.cache_class' => 'altoplaceresclDevUrlMatcher',
            'router.options.generator.cache_class' => 'altoplaceresclDevUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => (__DIR__.'/assetic/routing.yml'),
            'router.cache_class_prefix' => 'altoplaceresclDev',
            ...
            'debug.container.dump' => (__DIR__.'/altoplaceresclDevDebugProjectContainer.xml'),
            ...
            'assetic.write_to' => ($this->targetDirs[2].'/../../public_html/altoplaceres.cl/'),
