 ...
 */
class History extends \Uni\AdminBundle\Entity\History implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Uni\\AdminBundle\\Entity\\History' . "\0" . 'id', '' . "\0" . 'Uni\\AdminBundle\\Entity\\History' . "\0" . 'time', '' . "\0" . 'Uni\\AdminBundle\\Entity\\History' . "\0" . 'title', '' . "\0" . 'Uni\\AdminBundle\\Entity\\History' . "\0" . 'abstract', '' . "\0" . 'Uni\\AdminBundle\\Entity\\History' . "\0" . 'content', '' . "\0" . 'Uni\\AdminBundle\\Entity\\History' . "\0" . 'rank', '' . "\0" . 'Uni\\AdminBundle\\Entity\\History' . "\0" . 'published', '' . "\0" . 'Uni\\AdminBundle\\Entity\\History' . "\0" . 'path', '' . "\0" . 'Uni\\AdminBundle\\Entity\\History' . "\0" . 'file', '' . "\0" . 'Uni\\AdminBundle\\Entity\\History' . "\0" . 'createdAt', '' . "\0" . 'Uni\\AdminBundle\\Entity\\History' . "\0" . 'updatedAt', '' . "\0" . 'Uni\\AdminBundle\\Entity\\History' . "\0" . 'deletedAt');
        }
