...
use Uni\UserBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $entities = $em->getRepository('UniUserBundle:User')->findBy(array(), array($sort => $direction));
        else $entities = $em->getRepository('UniUserBundle:User')->findAll();
        $paginator = $this->get('knp_paginator');
        $pagination = $paginator->paginate($entities, $request->query->getInt('page', 1), 10);

        return $this->render('UniUserBundle:User:index.html.twig', array(
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('UniUserBundle:User:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UniUserBundle:User')->find($id);
        ...
        return $this->render('UniUserBundle:User:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('UniUserBundle:User:edit.html.twig', array(
            'entity'      => $entity,
